...
<body>
    ...
    <br><br>
    <form class="container" action="../control/traitementloginChallengeur.php" method="POST">
        ...
        <br> <br>
        <a href="signUpChallengeur.php">
            <p style="color: red;" ;>Je n'ai pas de compte, je m'inscris</p>
        </a>
    </form>
</body>
