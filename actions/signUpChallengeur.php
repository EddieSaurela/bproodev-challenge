...
<body>
    ...
    <br><br>
    <form class="container" action="../control/traitement_challengeur.php" method="POST">


        <div class="mb-3">
            <label for="nom_challengeur" class=" form-label">Nom:</label>
            <input type="text" class="form-control" name="nom_challengeur" required>
        </div>
        <div class="mb-3">
            <label for="prenom_challengeur" class="form-label">Prenom:</label>
            <input type="text" class="form-control" name="prenom_challengeur" required>
        </div>
        <div class="mb-3">
            <label for="email_challengeur" class="form-label">📧 Email:</label>
            <input type="text" class="form-control" name="email_challengeur" required>
        </div>
        <div class="mb-3">
            <label for="mdp_challengeur" class="form-label">Password:</label>
            <input type="password" class="form-control" name="mdp_challengeur" required>
        </div>
        <div class="mb-3">
